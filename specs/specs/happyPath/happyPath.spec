...
Kullanıcı ikinci kez geliyor - Adrese Teslim - Adresi var (yan menü)
--------------------------------------------------------------------
tags:kullanıcıİkinciKezGeliyor_adreseTeslim_adresiVar(yanMenü)
...
Kullanıcı ikinci kez geliyor - Gel Al - Adresi var (yan menü)
--------------------------------------------------------------
tags:kullanıcıİkinciKezGeliyor_gelAl_adresiVar(yanMenü)
...
* Adrese Teslim servis tipi seçilir
* Adrese Teslim servis tipi için Adalar / Burgazada mah. adresi eklenir
* Anasayfada adres teslim butonuna tıklanır
* Gel Al servis tipi seçilir
